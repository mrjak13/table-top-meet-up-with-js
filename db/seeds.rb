...
benny = User.create(name: "Benny", email: "benny@benny.com", password: "password")
...
first_meet_up = MeetUp.create(name: "Number 1!", location_id: local_1.id, meet_up_type_id: casual.id, date: DateTime.new(2019, 1, 25), time: DateTime.new(2019, 1, 25, 18))
